...
Internal cybersecurity platform for threat detection and employee education met AI-automatie
"""
...
app = FastAPI(
    ...
    description="Internal cybersecurity platform for threat detection and employee education - Nederlandse Implementatie",
    version=settings.app_version,
